...
export function Feedback() {
  ...
  return (
    feedback && (
      <div id="feedback-msg" className={`fixed top-4 left-1/2 -translate-x-1/2 z-[70] max-w-2xl w-full mx-auto px-4 rounded-lg p-4 text-sm font-medium shadow-lg transition-all duration-300 ${feedbackStyles}`}>
