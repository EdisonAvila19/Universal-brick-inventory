...
export default function ColorMultiSelect({ colors, selected, onChange, placeholder = "Search colors...", allLabel = "All Colors" }: Readonly<ColorMultiSelectProps>) {
  ...
  return (
    <div ref={containerRef} class="relative">
      ...
      {open && (
        <div class="absolute z-50 mt-1 w-auto bg-surface-container-highest rounded-xl shadow-2xl border border-outline-variant/20 overflow-hidden">
          ...
          <div class="max-h-60 overflow-y-auto">
            {filtered.length === 0 ? (
              <p class="text-center text-secondary text-sm py-4">No colors match</p>
            ) : (
              filtered.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span class="w-5 h-5 rounded-full shrink-0 shadow-inner" style={`background:${c.rgb}`} />
